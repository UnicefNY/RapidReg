...
public class IncidentPhotoViewActivity extends AppCompatActivity {
    @BindView(R.id.record_photo_view_slider)
    ViewPager viewPager;

    @Inject
    IncidentPhotoViewAdapter incidentPhotoViewAdapter;
    ...
    public void onCreate(Bundle savedInstanceState){
        ...
        viewPager.setLayoutParams(new RelativeLayout.LayoutParams(ViewGroup.LayoutParams
        .MATCH_PARENT,
        ViewGroup.LayoutParams.WRAP_CONTENT));

        incidentPhotoViewAdapter.setPaths(getIntent().getStringArrayListExtra("photos"));
        viewPager.setAdapter(incidentPhotoViewAdapter);
